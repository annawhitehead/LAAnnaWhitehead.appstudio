...
const cacheName = 'LAAnnaWhitehead-2021-09-29 14:01:38.071638'; // unique value, generated each deploy
  ...
  e.waitUntil(
    caches.keys().then((keyList) => {
      ...
      return Promise.all(keyList.map((key) => {
        ...
        if (cacheName.indexOf(key) === -1  && key.substr(0, 'LAAnnaWhitehead'.length) === 'LAAnnaWhitehead') {
